...
const PDFDownloadComponent = ({ informe }) => {
    ...
    const generatePDF = () => {
        ...
        informe.actividades.map((activity, index) => {
            ...
            doc.text(new Date(activity.fecha).toLocaleDateString(), 12, rowY);
    ...
    return (
        <button className="btn descargar" onClick={() => generatePDF() }>
            <img src="https://cdn-icons-png.flaticon.com/512/337/337946.png" alt="Descargar PDF" />
        </button>
    );
};
